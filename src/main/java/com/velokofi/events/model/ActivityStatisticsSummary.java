...
import static com.velokofi.events.VeloKofiEventsApplication.MetricType.DISTANCE;
...
public class ActivityStatisticsSummary {
    ...
    public ActivityStatisticsSummary(final ActivityStatistics activityStatistics) {
        ...
        this.percentComplete = ytdDistance.divide(VeloKofiEventsApplication.PLEDGE_DISTANCE, new MathContext(
